 ...
 */
#define BSWAP_32(val)                                                               \
  ((((uint32_t) (val) &0x000000ff) << 24) | (((uint32_t) (val) &0x0000ff00) << 8) | \
   (((uint32_t) (val) &0x00ff0000) >> 8) | (((uint32_t) (val) &0xff000000) >> 24))
 ...
 */
static inline leint64_t
cpu_to_le64 (uint64_t native)
{
 ...
 * @native: value to convert
 */
static inline leint32_t
cpu_to_le32 (uint32_t native)
{
 ...
 * @native: value to convert
 */
static inline leint16_t
cpu_to_le16 (uint16_t native)
{
 ...
 * @native: value to convert
 */
static inline beint64_t
cpu_to_be64 (uint64_t native)
{
 ...
 * @native: value to convert
 */
static inline beint32_t
cpu_to_be32 (uint32_t native)
{
 ...
 * @native: value to convert
 */
static inline beint16_t
cpu_to_be16 (uint16_t native)
{
